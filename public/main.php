    ...
    <div class="row">
        <?php
            while($row = mysqli_fetch_array($result)){
              if(($row['qty'] > 0) & ($row['status'] == 0)){
        ?>
        <div class="col-md-3 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
                    <div class="inner">
                        <div class="main-img"><img src="admin/img/<?php echo $row['image']; ?>" style="height:250px;" alt="Category"></div>
                        <!-- <div class="thumblist">
                ...
                <div class="card-body text-center">
                    <h4 class="card-title" style="font-size: 1.3rem;"><?php echo $row['model_name']; ?></h4>
                    <p class="text-muted">₹<?php echo $row['price']; ?></p>
                    <a class="btn btn-outline-primary btn-sm" name="button1"
                    href="<?php echo 'product-page.php?pid='.$row['pro_id']; ?>" data-abc="true">View Product</a>
                </div>
            </div>
        </div>
        <?php
